...
__global__ void unpack8bitcomplex_2chan_rotate(half2 *dest, const int8_t *src, float *rotVec, const int32_t *shifts, int fftsamples);
__global__ void unpack2bit_2chan_fast(cuComplex *dest, const int8_t *src, const int32_t *shifts, int fftsamples);
__global__ void unpack2bit_2chan_rotate(half2 *dest, const int8_t *src, float *rotVec, const int32_t *shifts, int fftsamples);
